...
public class AthleteResumedDTO implements Serializable {
    ...
    public String toString() {
        return "AthleteResumedDTO [id=" + id + ", codAthlete=" + codAthlete + ", name=" + name + ", dtBirth=" + dtBirth + ", nmFather="
                + nmFather + ", nmMother=" + nmMother + ", identity=" + identity + ", cpf=" + cpf + ", certBirth=" + certBirth + "]";
    }
